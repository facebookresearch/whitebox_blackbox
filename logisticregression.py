...
import argparse
from functions import computemAP, computeMATT, computeMetrics
...
def get_parser():
    ...
    parser.add_argument("--root_data", type=str, default="/private/home/asablayrolles/code/projects/dejalight")
